    ...
    <div id="appCapsule">
        ...
        <div class="section mb-5 p-2">
            <form id="form-login">
                ...
                <div class="form-links mt-2" style="float: right;">
                    <div>
                        <a class="btn btn-transparent text-primary" href="forgot"><i class="fa fa-key mr-1"></i> Lupa Kata Sandi?</a>
                    </div>
                </div>

                <div class="form-button-group transparent">
                <button type="submit" class="btn btn-success btn-block"><ion-icon name="log-in"></ion-icon> Masuk</button>
                <a href="oauth/google" class="btn btn-warning btn-block"><ion-icon name="logo-google"></ion-icon> Masuk dengan Google</a>
                <a href="registrasi" class="btn btn-primary btn-block"><ion-icon name="person-add-sharp"></ion-icon> Buat Akun</a>
                </div>
