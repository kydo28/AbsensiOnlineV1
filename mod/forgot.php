...
<!-- App Capsule -->
    <div id="appCapsule">
        <div class="section text-center">
            <h1 class="text-primary" style="font-size:24px;"><i class="text-primary fa fa-key"></i><br>Lupa Password</h1>
        </div>
            ...
            <form id="form-forgot">
                    ...
                    <div class="card-body pb-1">
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="email" class="form-control" id="email" name="employees_email" placeholder="Masukkan alamat email" required>
                ...
                <div class="p-2">
                    ...
                    <div class="pb-4 text-center">
                        <p>Kembali ke form?<a href="login" class="text-primary"> Login</a></p>
                    </div>
                </div>
