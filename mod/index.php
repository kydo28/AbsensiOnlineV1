<?php
	...
	<html lang="id-ID" xml:lang="id-ID">
	    ...
	    <head>
	    	...
	    	<meta content="<?php echo $site_url; ?>/content/logo/absensionline.png" property="og:image"/>
	    	...
	    	<meta content="<?php echo $site_url; ?>/content/logo/absensionline.png" property="twitter:image"/>
	    	...
	    	<link href="<?php echo $site_url; ?>/brantas3d.png" rel="apple-touch-icon"/>
	    	<link href="<?php echo $site_url; ?>/brantas3d.png" rel="shortcut icon" type="image/x-icon"/>
	    ...
	    <body>
	        ...
	        <div class="main-banner">
	        				...
	        				<div class="row h-100 justify-content-center align-items-center">
	        					<div class="col-lg-5">
	        						<div class="hero-content text-center text-white">
	        							<p>
	        								<img src="<?php echo $site_url; ?>/content/logo/brantas3d.png" class="img-fluid" width="180px">
	        							</p>
	        							...
	        							<!-- <i aria-hidden="true" class="fa fa-check-circle"></i> Powered by -->
	        						</div>
	        					</div>
	        					<div class="col-lg-6">
	        	...
	        	<div class="shape2 rotateme"><img src="mod/assets-index/images/shape2.png" alt="shape"></div>
	        	<div class="shape3"><img src="mod/assets-index/images/shape3.png" alt="shape"></div>
	        	<div class="shape4"><img src="mod/assets-index/images/shape4.png" alt="shape"></div>
	        	<div class="shape5"><img src="mod/assets-index/images/shape5.png" alt="shape"></div>
	        	<div class="shape6 rotateme"><img src="mod/assets-index/images/shape4.png" alt="shape"></div>
	        	<div class="shape7"><img src="mod/assets-index/images/shape4.png" alt="shape"></div>
	        	<div class="shape8 rotateme"><img src="mod/assets-index/images/shape2.png" alt="shape"></div>
	        </div>


	        <!--APLIKASI-->
	        <section class="services-area-two bg-white" id="aplikasi">
	        	<div class="container">
	        		<div class="section-title">
	        			<h2><i class="fab fa-android" style="color:#a4c639"></i> Aplikasi Absensi</h2>
	        			<div class="bar"></div>
