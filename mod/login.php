...
<!-- App Capsule -->
    <div id="appCapsule">
        <div class="section text-center">
            <h1 class="text-primary" style="font-size:24px;"><i class="text-primary fa fa-user"></i><br>Login</h1>
        </div>
        <div class="section mb-5 p-2">
            <form id="form-login">
                    ...
                    <div class="card-body pb-1">
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <label class="label position-absolute pt-2"><i class="fa fa-envelope"></i></label>
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <label class="label position-absolute pt-2"><i class="fa fa-key"></i></label>
                ...
                <div class="form-links mt-2" style="float: right;">
                    <div class="pb-4">
                        <a class="btn text-primary" href="forgot"></i> Lupa Kata Sandi?</a>
                    </div>
                </div>
                ...
                <div class="p-2">
                    ...
                    <div class="pb-4 text-center">
                        <p>Belum memiliki akun?<a href="registrasi" class="text-primary"> Daftar</a></p>
                    </div>
                </div>
