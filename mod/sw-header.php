...
<head>
  ...
  <meta content="'.$site_url.'/content/logo/absensionline.png" property="og:image"/>
  ...
  <meta content="'.$site_url.'/content/logo/absensionline.png" property="twitter:image"/>
  ...
  <link href="'.$site_url.'/brantas3d.png" rel="apple-touch-icon"/>
  <link href="'.$site_url.'/brantas3d.png" rel="shortcut icon" type="image/x-icon"/>
